    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='board.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Response',
            fields=[
                ...
                ('sender_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='board.customuser')),
            ],
        ),
    ]
